...
<body>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">MyFashionStore</h1>
                <p class="lead text-muted">Welcome to MyFashionStore, this store is created using Laravel 8 and
                    Bootstrap. For assignment purposes.</p>
                {{-- <p>
