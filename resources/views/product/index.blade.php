                ...
                @foreach ($queryBuilder as $product)
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <img style="max-height: 350px; object-fit:cover;" class="card-img-top"
                                data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail"
                                alt="Card image cap" src="{{ asset('images/'.$product->image) }}">
                            <div class="card-body">
                                <p class="card-text">{{ $product->name }}</p>
                                <p class="text-muted">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                                    Dolore repellat perspiciatis sunt maxime recusandae aspernatur provident quae.
                                    Aliquid ab repellat consequuntur.</p>
